...
public class PoiDemo  extends HttpServlet{


    /** Excel 文件要存放的位置，假定在D盘下 */
    public static String outputFile = "E:\\poiDemo.xls";
...
// 定义单元格为字符串类型
            ...
            cell.setCellStyle(cellStyle);
// 在单元格中输入一些内容
            cell.setCellValue(new HSSFRichTextString("小区门禁维修月报表"));
...
//填充数据
            for (int i = 0; i < 10; i++) {
                ...
                row.createCell(0).setCellValue(date);
                row.createCell(1).setCellValue("水道");
                row.createCell(2).setCellValue("清单");
                ...
                row.createCell(8).setCellValue("HUUU");
                row.createCell(9).setCellValue("2小时");
                row.createCell(10).setCellValue("200");
                row.createCell(11).setCellValue("100");
            }
